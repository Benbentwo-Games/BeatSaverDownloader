...
import (
	...
	"github.com/Benbentwo-Sandbox/BeatSaverDownloader/pkg/cmd/download"
	"github.com/Benbentwo-Sandbox/BeatSaverDownloader/pkg/version"
...
func NewMainCmd(in terminal.FileReader, out terminal.FileWriter, err io.Writer, args []string) *cobra.Command {
	...
	cmd.AddCommand(download.NewCmdDownload(commonOpts))
	return cmd
}
